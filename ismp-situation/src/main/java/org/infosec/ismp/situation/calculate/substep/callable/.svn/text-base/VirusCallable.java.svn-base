...
public class VirusCallable implements Callable<ResultExponential> {
	...
	public VirusCallable(Map<String, int[]> counts, int vindex, Timestamp vtime,List<SituationEvent> list) {
		this.counts = counts;
		this.index = vindex;
		this.time = vtime;
		this.list = list;
