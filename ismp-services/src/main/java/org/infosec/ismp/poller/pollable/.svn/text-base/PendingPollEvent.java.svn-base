...
public class PendingPollEvent extends PollEvent {
	...
	private final List<Runnable> m_pendingOutages = new LinkedList<Runnable>();
	...
	public String toString() {
		return m_event + ", uei: " + m_event.getUei() + ", id: "
				+ m_event.getUuid() + ", isPending: " + m_pending
