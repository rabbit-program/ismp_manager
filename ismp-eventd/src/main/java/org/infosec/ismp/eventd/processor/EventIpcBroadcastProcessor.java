...
import org.infosec.ismp.eventd.EventIpcBroadcaster;
 ...
 */
public class EventIpcBroadcastProcessor implements EventProcessor,
		InitializingBean {
	private EventIpcBroadcaster m_eventIpcBroadcaster;

	@Override
	public void afterPropertiesSet() throws IllegalStateException {
		Assert.state(m_eventIpcBroadcaster != null,
