...
public class ICMPSearchProcessPanel extends JPanel implements ActionListener{
     ...
     * @param icmpPanel
     */
    public ICMPSearchProcessPanel(ICMPPanel icmpPanel) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (source == stop) {
        	 JOptionPane.showMessageDialog(ICMPSearchProcessPanel.this,"正在停止，请耐心等待...","提示" , JOptionPane.INFORMATION_MESSAGE);
            stop.setEnabled(false);
            ICMPSearchAppletService icmpSearchService = ICMPSearchAppletService.getInstance();
            icmpSearchService.stopSearch(false);
        }
    }        
    /**
     * 设置发现进度百分比
