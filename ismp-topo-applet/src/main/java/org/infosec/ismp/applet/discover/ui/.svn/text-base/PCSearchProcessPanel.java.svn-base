 ...
 * @version 1.0
 */
public class PCSearchProcessPanel extends JPanel implements ActionListener {
     ...
     * @param pcPanel
     */
    public PCSearchProcessPanel(PCPanel pcPanel) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (source == stop) {
        	JOptionPane.showMessageDialog(PCSearchProcessPanel.this,"正在停止，请耐心等待...","提示" , JOptionPane.INFORMATION_MESSAGE);
    		stop.setEnabled(false);
            PCSearchAppletService pcSearchService = PCSearchAppletService.getInstance();
            pcSearchService.stopSearch(false);
        }
    }        
    /**
     * 设置发现进度百分比
