...
insert into `ismp_user` (`id`, `description`, `email`, `enabled`, `end_lock_time`, `expired_time`, `job`, `login_name`, `mobile`, `password`, `phone`, `registertime`, `username`, `version`) 
                  values('1',NULL,NULL,'true',NULL,NULL,'admin','admin',NULL,'fc2d169cbb6e0e54b5cdc7a64e0d8122',NULL,NULL,'admin',NULL);
insert into `ismp_user` (`id`, `description`, `email`, `enabled`, `end_lock_time`, `expired_time`, `job`, `login_name`, `mobile`, `password`, `phone`, `registertime`, `username`, `version`) 
                  values('2',NULL,NULL,'true',NULL,NULL,'DomainAdminAll','DomainAdminAll',NULL,'fc2d169cbb6e0e54b5cdc7a64e0d8122',NULL,NULL,'DomainAdminAll',NULL);
insert into `ismp_user` (`id`, `description`, `email`, `enabled`, `end_lock_time`, `expired_time`, `job`, `login_name`, `mobile`, `password`, `phone`, `registertime`, `username`, `version`) 
                  values('3',NULL,NULL,'true',NULL,NULL,'DomainAdminLocal','DomainAdminLocal',NULL,'fc2d169cbb6e0e54b5cdc7a64e0d8122',NULL,NULL,'DomainAdminLocal',NULL);
insert into `ismp_user` (`id`, `description`, `email`, `enabled`, `end_lock_time`, `expired_time`, `job`, `login_name`, `mobile`, `password`, `phone`, `registertime`, `username`, `version`) 
                  values('4',NULL,NULL,'true',NULL,NULL,'other','other',NULL,'fc2d169cbb6e0e54b5cdc7a64e0d8122',NULL,NULL,'other',NULL);
