package edu.sjtu.infosec.ismp.manager.VPM.sd.dao;
...
public interface SoftwareManagerDao {
    ...
    * @return
    */
   public Object searchByConditionsCount(SoftwareInfo softwareInfo,PMPage page,Timestamp uploadStartTime,Timestamp uploadEndTime);
   /**
    * 根据id 查询对象
    * @param id
    * @return
