 ...
 * @version 1.0
 */
public class EventGroupBySubDomain extends Action {
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        try{
            ...
            jrxmlFilePathList.add(application.getRealPath("/reports/EM/EventGroupBySubDomainImage.jrxml"));
            jrxmlFilePathList.add(application.getRealPath("/reports/EM/EventGroupBySubDomainTable.jrxml"));
            jrxmlFilePathList.add(application.getRealPath("/reports/EM/EventGroupBySubDomain.jrxml"));
            //.jasper
            String reportFilePath = application.getRealPath("/reports/EM/EventGroupBySubDomain.jasper");
            
            ExportToFileOrHtml export = new ExportToFileOrHtml();
            
            if(outPutFileType==2){
                String outPutFileUrl = application.getRealPath("/reports/EM/EventGroupBySubDomain.rtf");
                response.addHeader("Content-Disposition", "attachment; filename=EventGroupBySubDomain.rtf");
                ...
                String outPutFileUrl = application.getRealPath("/reports/EM/EventGroupBySubDomain.pdf");
                response.addHeader("Content-Disposition", "attachment; filename=EventGroupBySubDomain.pdf");
