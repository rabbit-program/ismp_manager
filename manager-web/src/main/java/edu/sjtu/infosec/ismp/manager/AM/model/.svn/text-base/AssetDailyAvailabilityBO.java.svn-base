...
/**
 * asset_daily_availability的BO类
 * 
 * @author zjiajie
 * 
 */
@Entity
@Table(name = "am_daily_availability")
@org.hibernate.annotations.Entity(dynamicUpdate = true)
public class AssetDailyAvailabilityBO {
	@Id
	...
	public AssetDailyAvailabilityBO() {
		super();
	}

	 

	public AssetDailyAvailabilityBO(Integer assetId, Integer availabilityType,
			String singleCode, Timestamp time, Integer usedPercent) {
		super();
	...
	public boolean equals(final Object other) {
		if (!(other instanceof AssetDailyAvailabilityBO))
			return false;
		AssetDailyAvailabilityBO castOther = (AssetDailyAvailabilityBO) other;
