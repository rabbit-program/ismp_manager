 ...
 * @version 1.0
 */
public class EventGroupByDeviceType extends Action {
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        try{
            ...
            jrxmlFilePathList.add(application.getRealPath("/reports/EM/EventGroupByDeviceTypeImage.jrxml"));
            jrxmlFilePathList.add(application.getRealPath("/reports/EM/EventGroupByDeviceTypeTable.jrxml"));
            jrxmlFilePathList.add(application.getRealPath("/reports/EM/EventGroupByDeviceType.jrxml"));
            //.jasper
            String reportFilePath = application.getRealPath("/reports/EM/EventGroupByDeviceType.jasper");
            
            ExportToFileOrHtml export = new ExportToFileOrHtml();
            
            if(outPutFileType==2){
                String outPutFileUrl = application.getRealPath("/reports/EM/EventGroupByDeviceType.rtf");
                response.addHeader("Content-Disposition", "attachment; filename=EventGroupByDeviceType.rtf");
                ...
                String outPutFileUrl = application.getRealPath("/reports/EM/EventGroupByDeviceType.pdf");
                response.addHeader("Content-Disposition", "attachment; filename=EventGroupByDeviceType.pdf");
