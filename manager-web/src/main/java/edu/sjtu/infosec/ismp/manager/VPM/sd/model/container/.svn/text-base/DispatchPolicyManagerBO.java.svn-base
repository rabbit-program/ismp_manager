...
/**
 * @Title: DispatchPolicyManagerBO.java
 * @Package edu.sjtu.infosec.ismp.manager.virus.software.model
 * @Description: 分发策略信息对象
 * @author wjianzhuo
 * @date 2009-8-12 上午10:51:14
 * @version V1.0
 */

public class DispatchPolicyManagerBO implements Serializable {
	...
	*/
	 ...
	 */
	public void setDispatchStartDate(String vDispatchStartDate) {
	 ...
	 */
	public void setDispatchEndDate(String vDispatchEndDate) {
	...
	public boolean equals(Object other) {
		if (!(other instanceof DispatchPolicyManagerBO))
			return false;
		DispatchPolicyManagerBO castOther = (DispatchPolicyManagerBO) other;
		return new EqualsBuilder().append(consistencyCheckTag,
	...
	public int hashCode() {
		...
		return new HashCodeBuilder().append(consistencyCheckTag).append(
	...
	public String toString() {
		// TODO Auto-generated method stub
		return new ToStringBuilder(this).append("consistencyCheckTag",
