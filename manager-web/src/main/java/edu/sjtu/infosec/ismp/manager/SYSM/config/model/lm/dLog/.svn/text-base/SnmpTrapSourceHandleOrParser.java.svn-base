...
@Entity
@Table(name="lm_dl_trap_handle_or_parser")
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
public class SnmpTrapSourceHandleOrParser implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5568108112255973593L;
