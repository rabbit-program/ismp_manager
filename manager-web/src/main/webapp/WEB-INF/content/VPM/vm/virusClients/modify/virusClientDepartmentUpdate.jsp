	            ...
	            <tr>
	              ...
	              <td bgcolor="f9f9fb">
	                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="css1">
			          <tr align="center">
	                    <td colspan="4">
	                        <font size="2"><p class="STYLE2"><br>部门名称更新</p></font>
	                        <hr size="5" />
	                    </td>
	                  </tr>
					  <tr align="left">
						  <td width="35%" align="right">部门名称&nbsp;：</td>
						  <td width="33%" align="left">&nbsp;&nbsp;
							  <select name="department" id="department" style="width: 290px;">
	                              <c:forEach var="manager" items="${depList}">
					  ...
					  <tr align="center">
					    ...
					    <td>
					      ...
					      <input name="button3" type="button" class="an-2" id="button3" value="关 闭" onclick="window.close();" /></td>
					  </tr>
	                </table>
	              </td>
			      <td background="/images/a-023.gif">&nbsp;</td>
