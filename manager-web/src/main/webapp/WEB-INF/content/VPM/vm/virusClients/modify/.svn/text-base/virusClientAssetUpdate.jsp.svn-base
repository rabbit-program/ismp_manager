              ...
              <tr>
	              ...
	              <td bgcolor="f9f9fb">
	                  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="css1">
			              <tr align="center">
				              <td colspan="4">
                                <font size="2"><p class="STYLE2"><br>资产编号更新</p></font>
				                <hr size="5" />
                              </td>
						  </tr>
			              <tr align="left">
				              <td width="35%" align="right">资产编号&nbsp;：</td>
				              <td width="33%" align="left">&nbsp;&nbsp;
					              <select name="assetDevice" id="assetDevice" style="width: 290px;">
                                      <c:forEach var="device" items="${assetDeviceList}">
                                        <option value="${device.id }" >${device.sn }(${device.ip })</option>
                                      </c:forEach>
					              </select>
				              </td>
			              </tr>
