...
function updateStatus(id,status){
	...
	window.location.href="sysLogConfigAction.do?method=updateSysLogSource&id=" + id + "&startCollect=" + op;
}
...
<div id="contant" class="mainbg">
  ...
  <div class="contant"><h2 class="martop10">当前为SysLog日志源配置</h2>
    <div class="greenborder pad3 overf">
<div class="greenborder greenback overf pad3 Height_a" >
<form action="sysLogConfigAction.do?method=getSysLogSource" method="post" onsubmit="return validate_SysLogConfigSourceQuery()">
...
<a href="sysLogConfigAction.do?method=initSysLogSourceType" class="R6 R7 boxy" title="添加日志源"  style="margin-left:80px;">添加日志源</a> <a href="${ctx}/ismp/domain/local/sysm/sysConfig.do" class="R6 R7">返回上一级</a>
</div>
      ...
      <ul id="page">
        <li><a class="first" href="sysLogConfigAction.do?method=getSysLogSource&type=page"></a></li>

		<c:if test="${pageResult.pageNo-1 >= 1}">
        	<li><a class="pre" href="sysLogConfigAction.do?method=getSysLogSource&type=page&pageNo=${pageResult.pageNo-1 }"></a></li>
		</c:if>
		<c:if test="${pageResult.pageNo-1 == 0}">
        	<li><a class="pre" href="sysLogConfigAction.do?method=getSysLogSource&type=page"></a></li>
		</c:if>

		<c:if test="${pageResult.pageNo+1 < pageResult.pageMaxSum}">
        	<li><a class="next" href="sysLogConfigAction.do?method=getSysLogSource&type=page&pageNo=${pageResult.pageNo+1 }"></a></li>
		</c:if>
		<c:if test="${pageResult.pageNo+1 >= pageResult.pageMaxSum}">
        	<li><a class="next" href="sysLogConfigAction.do?method=getSysLogSource&type=page&pageNo=${pageResult.pageMaxSum }"></a></li>
		</c:if>

			<li><a class="last" href="sysLogConfigAction.do?method=getSysLogSource&type=page&pageNo=${pageResult.pageMaxSum }"></a></li>
        <li>共 ${pageResult.pageMaxSum } 页 跳至
          <input type="text" size="2" class="input" name="mark"/>
          &nbsp; </li>
        <li><a class="R6" href="javascript:goPage('${pageResult.pageMaxSum }','sysLogConfigAction.do?method=getSysLogSource&type=page');">GO</a></li>
      </ul>
      <br />
      <br />
      <br />
