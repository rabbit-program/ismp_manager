...
<html>
    ...
    <body>
        <!-- <div class="leftblock border mar8 pad8"> -->
            ...
            <% 
                List<String> sList = (List<String>)request.getAttribute("sList");//状态
                Map<String, Integer> scMap = (Map<String, Integer>)request.getAttribute("scMap");//各个状态对应的记录数目统计
                if(sList!=null && sList.size()>0){
                    DefaultPieDataset clientData = new DefaultPieDataset();
                    for(String state: sList){
                        clientData.setValue(state,scMap.get(state));
                    }
