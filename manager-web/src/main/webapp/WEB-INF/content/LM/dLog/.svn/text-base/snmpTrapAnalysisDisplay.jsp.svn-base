...
function goDivPage(totalPage,href,div) {
    ...
    if(mark > totalPage){
    	...
    	showAddDivBox('snmpTrapDivSourceAction.do?method=snmpTrapDeviceForward&pageNo='+mark,div);
    }
}
</script>
</head>
<body onload="showAddDivBox('snmpTrapDivSourceAction.do?method=snmpTrapDeviceForward&pageNo=1','snmpTrapDisplay')">
<div id="contant" class="mainbg">
  ...
  <div class="contant">
   <div class="overf h20 martop10">
	...
	<div class="greenborder pad3 overf" id="snmpTrapDisplay"">
	数据加载中...
	</div>
