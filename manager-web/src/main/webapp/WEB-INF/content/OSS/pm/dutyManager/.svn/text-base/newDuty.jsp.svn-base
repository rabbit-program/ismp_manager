...
<html>
    <head>
        ...
        <title>运维支撑--值班管理--排班管理--新增排班</title>
        ...
        <script type="text/javascript" src="${ctx}/js/OSS/PM/complaint.js"></script>
       ...
       <form action="${ctx}/ismp/oss/pm/dsinfo.do?method=dsadd" method="post" name="f1" id="f1">
          <table width="100%" id="senfe" sortcol="-1">
              ...
              <tr>
               ...
               <td colspan="6">
                    <input type="text" size="8" id="startTime"   name="startTime" class="input" readonly="readonly"  onclick="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd HH:mm:ss'})"/> 
                    —
                    <input type="text" size="8" id="endTime" name="endTime" class="input" readonly="readonly" onclick="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
                </td>
              </tr>
              <tr>
             <th width="18%" style="">人员指定<span class="webdings"></span></th>
              ...
              <tr>
                ...
                <td colspan="5"><textarea name="task" cols="100%" 
 rows="5" id="task"  ></textarea></td>
              </tr>
          </table>
