...
/************** 加入功能按钮公共样式 *********************/
  this.insertTbCell=function(trRow,cellIndex,TXT,trAlign,tbColSpan){
   ...
   btnCell.style.cssText="width:100%;border:1 outset;background-color:#1D7D76;";
  ...
  //  btnCell.style.cssText="width:100%;border:1 inset;background-color:#1D7D76;";
  // }
   ...
   for(i=0;i<theRows;i++){
    ...
    for(j=0;j<7;j++){
     ...
     if(n>theFirstDay && n<=theMonthLen){
      ...
      theCell.style.cssText="background-color:#1D7D76;cursor:default;";
     }
    }
   }
  ...
  this.insertBodyCell=function(theRow,j,day,targetObject){
   var theCell=theRow.insertCell(j);
   if(j==0) var theBgColor="#FFFFFF";
   else var theBgColor="#DDEEEE";
   if(day==calendar.currentDate[2]) var theBgColor="#CCCCCC";
   if(day==calendar.today[2]) var theBgColor="#B6DCFF";
